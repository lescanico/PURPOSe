...
patients_feat <- readRDS("data/patients_90d_12m.rds")
...
```{r util_class, eval=FALSE, echo=FALSE}
...
![](tables/utilization_summary.png)
...
# Save
ggsave("figures/utilization_pareto.png", pareto_plot, dpi = 300)
```

![](figures/utilization_pareto.png)
