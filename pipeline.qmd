...
if (!dir.exists("data/mod")) dir.create("data/mod", recursive = TRUE)
...
features <- engineer_utilization(
  ...
  id_var = "patient_id",
  demographic_vars = c("age", "sex", "race", "is_hispanic", "marital_status", "religion", "zip3"),
  visit_vars = c("length", "status", "type", "provider_type", "los", "payer", 
                 "copay_col", "copay_due", "prepay_col", "prepay_due", 
                 "portal_engagement", "is_portal_active", "is_tele"),
  diagnosis_var = "diagnosis",
  medications_var = "medications",
  observed_days = 90,
  prediction_months = 12,
  output_path = "data/mod/90d_12m.rds"
)
```
